   ...
   {/* Skip to main content link for accessibility */}      <a
      ...
      <footer className="bg-ayur-green-dark text-ayur-cream relative overflow-hidden pb-20 md:pb-0 border-t border-white/5">
       ...
       <WhatsAppBubble />
         ...
         <button
         onClick={scrollToTop}
         className={`fixed bottom-40 md:bottom-24 right-4 z-[70] p-3 rounded-full bg-ayur-green text-white shadow-lg hover:bg-ayur-green-dark transition-all duration-300 transform hover:scale-110 active:scale-95 ${
